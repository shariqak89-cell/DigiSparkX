      ...
      <section className="section">
        <div className="shell story-grid">
          <div>
            ...
            <p>His vision is to make Artificial Intelligence simple, useful and opportunity-focused for students, professionals, entrepreneurs, teachers and growing businesses.</p>
          </div>
